# database/insert_test_data.py
"""
Script de Seeding : Insertion des données initiales de test pour la démonstration.
Insère des utilisateurs (Admin, Technicien, Utilisateur), des incidents et des interventions.
"""
import sys
import os

# Permet d'importer les modules même si le script est exécuté depuis un sous-dossier
